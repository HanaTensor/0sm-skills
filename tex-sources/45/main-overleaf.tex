...
\title{Open-Path Spinorial Transport in the 0-Sphere Model\\ and the Status of Torsion:\\ Holonomy Sufficiency and the Possibility of Emergent Semigroup Geometry\\
...
\begin{table*}[t!]
\centering
\caption{\textbf{Candidate mechanisms for torsion in the 0-Sphere model}}
...
\begin{table*}[t!]
\centering
\caption{\textbf{The two interpretations of $\Delta\varphi(A,B)$ and their consequences}}
\label{tab:dichotomy}
\renewcommand{\arraystretch}{1.5}
\setlength{\tabcolsep}{7pt}
...
\begin{table*}[t!]
\centering
\caption{\textbf{Classification of geometric structures by curvature and torsion}}
\label{tab:geometry}
\renewcommand{\arraystretch}{1.5}
\setlength{\tabcolsep}{7pt}

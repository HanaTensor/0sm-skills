...
\begin{figure*}[t!] % figure*環境（2カラムまたがり）
    ...
    \resizebox{\textwidth}{!}{% !で縦横比を維持
        \input{fig_TotalHamiltonian.tikz}%
    }
...
\begin{equation}
  ...
  \label{eq:energy_conservation}
\end{equation}
Positive and negative energy states are distinguished by the sign of the time derivative of the thermal potential energy at each kernel. Differentiating \eqref{eq:energy_conservation} yields
\begin{align*}

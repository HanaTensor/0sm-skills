...
% セクション番号を全レイヤーで表示（I, II, III / A, B / 1, 2 / a, b）
...
% ============================================================
% TikZ figure: structural comparison diagram  (redesigned)
% Full figure* width exploited: x in [-8.4, 8.4]
% ============================================================
...
%% Surplus double-arrow (between end of L₀ and end of L_lab)
...
%% L₀: short dashed arrow (visually ~1/4 of L_lab)
...
%% Orange arc 0° → 33° (excess a_e·2πr, exaggerated)
...
%% Row C: excess arc label — pushed outward (r=2.75, angle=12°) below Row A
...
%% γ_L formula (lower-right area, clear of circle bottom y≈-0.60)

...
Section~\ref{sec:consistency} develops the interpretation of the Einstein equation as a global consistency condition within the connection-based framework, drawing a structural analogy with distributed consistency verification. We conclude in Section~\ref{sec:conclusion} with a discussion of conceptual implications and future directions.

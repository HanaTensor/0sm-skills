...
% ========================================
% #52: Geometric Origin of the Weak Equivalence Principle
...
%
% -------------------------------------------------------------
% This paper (#52) is part of the 0-Sphere model series (2018–).
% It is a Structural Proposal whose primary result is a structural
% derivation of the weak equivalence principle via the λ_C
% cancellation theorem, and whose secondary results are a directional
% classification of the three fundamental interaction types and the
% identification of the deterministic ZB axis drift as the single-
% particle mechanism for gravitational coupling.
%
...
%   #34 (hanamura34) — emergent gravitational dynamics (metronome)
%   #38 (hanamura38) — g=2 as phase-topological invariant; EPR
%   #47 (hanamura47) — AMM as rotational Lorentz contraction
%              DOI: 10.5281/zenodo.19120057
%   #49 (hanamura49) — photon-sphere ejection mechanism; Tomonaga;
%              Thomas precession; UV cutoff
%              DOI: 10.5281/zenodo.19393391
%   #50 (hanamura50) — angular momentum from scalar oscillation;
%              chirality χ = sign(da/dt); 4 Dirac components
%   #51 (hanamura51) — helical trajectory; two velocity scales;
%              metric emergence via Synge world function
%
% PRIMARY NEW RESULT IN #52:
%   The λ_C cancellation theorem: the Compton wavelength cancels
%   exactly from the gravitational force derivation because the ZB
%   axis vector ê governs both the energy-collection scale
%   (δE ∝ λ_C(ê·ĝ)) and the cycle rate (ω_ZB/2π = v_ZB/λ_C).
%   This common geometric origin makes the cancellation structural,
%   not algebraic, and yields F ∝ m_e g for a single particle with
%   no free parameters — a structural derivation of the WEP.
%
% SECONDARY NEW RESULTS IN #52:
%   (i)   Directional decomposition: v ∥ ê_x → gravity,
%         a ∥ ê_y → EM radiation, v×a ∥ ê_z → Thomas precession/spin.
%   (ii)  Distinction between the orthogonality of cos⁴/sin⁴ in
%         internal phase space and the orthogonality of v,a in
%         physical 3-space: related by a causal chain, not identical.
%   (iii) Deterministic ZB axis drift from anomalous magnetic moment
%         a_e: the helical trajectory does not close (g ≠ 2 externally),
%         causing the ZB axis ê to precess deterministically each cycle.
%
% OPEN TASKS RECORDED IN #52:
...
%   (iv)  Origin of the β_ZB = v_ZB/c coefficient: the derivation
%         yields F = m_e g β_ZB with β_ZB ≈ 0.04; the mechanism by
%         which the full Newtonian F = m_e g is recovered is an open
%         task for subsequent work.
%   (v)   Bell's inequality in the context of the deterministic
%         hidden-variable program (deferred to subsequent work).
%
% METHODOLOGICAL NOTE:
%   This paper is explicitly a Structural Proposal. Results labeled
%   'established' follow from prior papers in the series. Results
%   labeled 'proposal' are new structural claims supported by
%   physical argument and dimensional consistency. The distinction
...
% [1] First cited in abstract (v_ZB, beta_ZB from a_e)
...
% [2] First cited in §1 (gravitational mediator)
...
% [3] First cited in §1 (helical trajectory)
...
% [4] First cited in §1 (Einstein realist program)
...
% [5] First cited in §1 (realist program series)
...
% [6] First cited in §2 (lever arm geometry, AMM from internal structure)
...
% [7] First cited in §3 (foundational energy identity)
...
% [8] First cited in §4 (metronome / gravitational synchronization)
...
% [9] First cited in §4 (Thomas precession direction)
\bibitem{thomas1926} L.~H.~Thomas, ``The Motion of the Spinning Electron,'' Nature \textbf{117}, 514 (1926).

% [10] First cited in §4 (Thomas angular velocity vector)
...
% [11] First cited in §4 (Berry phase / spin)
...
% [14] First cited in §4 (g=2 U(1) fiber bundle)
...
% [15] First cited in §4 (derivative-order mismatch)
...
% [16] First cited in §5 (turning-point energy, energy floor)
...
% [17] First cited in §6 (angular momentum, chirality)
...
% [21] First cited in Appendix C (Conway's Game of Life)
...
% [22] First cited in Appendix C (de Broglie-Bohm deterministic program)
...
% [23] First cited in Appendix D (Weinberg-Witten theorem)

...
% 調和振動とローレンツ収縮による電子スピン再定義：0-Sphere模型の基礎
...
% 量子力学と一般相対論の架橋：第一原理による異常磁気モーメント
...
% Zitterbewegungの原論文：ディラック方程式から導出される振動運動
...
% 0-Sphere模型での量子振動：放射エネルギー移動による統一理論
...
% 幾何学的代数によるZitterbewegung解釈：数学的構造の物理的意味
...
% 電子内部幾何学とZitterbewegung：古典的模型による解釈
...
% Gravity Probe B：測地的歳差運動とフレーム引きずり効果の測定

...
\justifying
The following open problems have been explicitly formulated in the papers listed, with the exception of O18 and O19, which were formulated in the course of preparing an earlier draft of this overview and are attributed to it. Each represents a well-posed question whose resolution would advance the programme in a concrete way. Where a later paper has partially advanced a task, the status is noted; tasks are retained in the registry until fully resolved.

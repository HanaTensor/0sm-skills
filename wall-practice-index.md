...
> ⚠️ **0.040374c は棄却（2026-07-25 著者判断）** — コーパスが認める内部速度は #10 の **0.04047c** ただ一つ。「精密化された値」「代替値」として提示しないこと。
> 保有8本 = #14/#15/#17/#20/#22/#23/#27/#37。ただし**過剰棄却の禁止**: #22 の Δν/ν≈5.29×10⁻¹⁰（時計比）と #15 の橋渡し方程式 γ=1+a は無関係で存続。
